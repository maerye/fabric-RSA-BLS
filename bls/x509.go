...
func marshalPublicKey(pub interface{}) (publicKeyBytes []byte, publicKeyAlgorithm pkix.AlgorithmIdentifier, err error) {
	...
	case *PublicKey:
		...
		publicKeyAlgorithm.Algorithm = oidPublicKeyBLS
		publicKeyAlgorithm.Parameters = asn1.NullRawValue
...
var (
	...
	oidSignatureBLSWithSHA256 = asn1.ObjectIdentifier{1, 2, 840, 12591, 4, 3, 4}
...
var signatureAlgorithmDetails = []struct {
	...
	{BLSWithSHA256,"BLS-SHA256",oidSignatureBLSWithSHA256,BLS,crypto.SHA256},
}
...
var (
	...
	oidPublicKeyBLS = asn1.ObjectIdentifier{1, 2, 840, 12345, 2, 1}
)
...
func getPublicKeyAlgorithmFromOID(oid asn1.ObjectIdentifier) PublicKeyAlgorithm {
	...
	case oid.Equal(oidPublicKeyECDSA):
		return ECDSA
	case oid.Equal(oidPublicKeyBLS):
		return BLS
...
func checkSignature(algo SignatureAlgorithm, signed, signature []byte, publicKey crypto.PublicKey) (err error) {
	...
	case *PublicKey:
		...
		_,err= pub.Verify(signature,digest)
		return
	}
	return ErrUnsupportedAlgorithm
}
...
func signingParamsForPublicKey(pub interface{}, requestedSigAlgo SignatureAlgorithm) (hashFunc crypto.Hash, sigAlgo pkix.AlgorithmIdentifier, err error) {
	...
	case *PublicKey:
		pubType = BLS
		hashFunc = crypto.SHA256
		sigAlgo.Algorithm = oidSignatureBLSWithSHA256
	default:
...
func CreateCertificate(rand io.Reader, template, parent *Certificate, pub, priv interface{}) (cert []byte, err error) {
	...
	//signatureAlgorithm.Algorithm=oidSignatureBLSWithSHA256
